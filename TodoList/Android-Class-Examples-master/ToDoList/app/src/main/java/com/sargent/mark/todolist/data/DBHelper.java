...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        // Added category and status as datatype of TEXT
        String queryString = "CREATE TABLE " + Contract.TABLE_TODO.TABLE_NAME + " ("+
                ...
                Contract.TABLE_TODO.COLUMN_NAME_TODO_CATEGORY + " TEXT, " +
                Contract.TABLE_TODO.COLUMN_NAME_TODO_STATUS + " TEXT" +
                "); ";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        db.execSQL("drop table" + Contract.TABLE_TODO.TABLE_NAME + "id exist");
        onCreate(db);
    }
}
